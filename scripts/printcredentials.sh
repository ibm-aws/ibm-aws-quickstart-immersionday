...
function print_values() {
  ...
  export db2_deploy_id=`(oc get db2ucluster -n zen-46 | grep 'db2oltp-[0-9]' | awk '{print $1}')`
  export hostname=`(oc get po -o wide -n zen-46 | grep c-$db2_deploy_id-db2u-0 |  awk '{ printf $7 }')`
