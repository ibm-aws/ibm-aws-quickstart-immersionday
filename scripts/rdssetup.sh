...
wget $GITHUBURL/raw/main/rds/csv/CASES_AGESEX_refined.csv -O ./csv/CASES_AGESEX_refined.csv
wget $GITHUBURL/raw/main/rds/csv/HOSP_refined.csv -O ./csv/HOSP_refined.csv
wget $GITHUBURL/raw/main/rds/csv/MORT_refined.csv -O ./csv/MORT_refined.csv
wget $GITHUBURL/raw/main/rds/csv/Merged_HOSP_CAS.csv -O ./csv/Merged_HOSP_CAS.csv
wget $GITHUBURL/raw/main/rds/csv/Merged_VACC_MORT.csv -O ./csv/Merged_VACC_MORT.csv
wget $GITHUBURL/raw/main/rds/csv/TESTS_refined.csv -O ./csv/TESTS_refined.csv
wget $GITHUBURL/raw/main/rds/csv/VACC_refined.csv -O ./csv/VACC_refined.csv
wget $GITHUBURL/raw/main/rds/csv/account.csv -O ./csv/account.csv
wget $GITHUBURL/raw/main/rds/csv/address.csv -O ./csv/address.csv
wget $GITHUBURL/raw/main/rds/csv/credit_card.csv -O ./csv/credit_card.csv
wget $GITHUBURL/raw/main/rds/csv/data_country_level.csv -O ./csv/data_country_level.csv
wget $GITHUBURL/raw/main/rds/csv/flanders_cases_prediction_table.csv -O ./csv/flanders_cases_prediction_table.csv
wget $GITHUBURL/raw/main/rds/csv/healthcare_personnel_integrated_data_table.csv -O ./csv/healthcare_personnel_integrated_data_table.csv
wget $GITHUBURL/raw/main/rds/csv/healthcare_personnel_integrated_data_table_v1.csv -O ./csv/healthcare_personnel_integrated_data_table_v1.csv
wget $GITHUBURL/raw/main/rds/csv/healthcare_personnel_integrated_datatable_v1.csv -O ./csv/healthcare_personnel_integrated_datatable_v1.csv
wget $GITHUBURL/raw/main/rds/csv/merged_pii_data_source.csv -O ./csv/merged_pii_data_source.csv
wget $GITHUBURL/raw/main/rds/csv/merged_pii_info_table.csv -O ./csv/merged_pii_info_table.csv
wget $GITHUBURL/raw/main/rds/csv/mort.csv -O ./csv/mort.csv
wget $GITHUBURL/raw/main/rds/csv/mylan_specialty_personnel_data_table.csv -O ./csv/mylan_specialty_personnel_data_table.csv
wget $GITHUBURL/raw/main/rds/csv/pii_info.csv -O ./csv/pii_info.csv
wget $GITHUBURL/raw/main/rds/csv/test.csv -O ./csv/test.csv
wget $GITHUBURL/raw/main/rds/csv/transaction.csv -O ./csv/transaction.csv
wget $GITHUBURL/raw/main/rds/csv/ts-data-region.csv -O ./csv/ts-data-region.csv
wget $GITHUBURL/raw/main/rds/csv/ts-data-region_mod.csv -O ./csv/ts-data-region_mod.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Belgium.csv -O ./csv/ts_Belgium.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Belgium_agg.csv -O ./csv/ts_Belgium_agg.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Brussels.csv -O ./csv/ts_Brussels.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Brussels_agg.csv -O ./csv/ts_Brussels_agg.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Flanders.csv -O ./csv/ts_Flanders.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Flanders_agg.csv -O ./csv/ts_Flanders_agg.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Wallonia.csv -O ./csv/ts_Wallonia.csv
wget $GITHUBURL/raw/main/rds/csv/ts_Wallonia_agg.csv -O ./csv/ts_Wallonia_agg.csv
wget $GITHUBURL/raw/main/rds/csv/ts_belgium_covid_statistics_table.csv -O ./csv/ts_belgium_covid_statistics_table.csv
wget $GITHUBURL/raw/main/rds/csv/ts_brussels_region_table.csv -O ./csv/ts_brussels_region_table.csv
wget $GITHUBURL/raw/main/rds/csv/ts_flanders_region_table.csv -O ./csv/ts_flanders_region_table.csv
wget $GITHUBURL/raw/main/rds/csv/ts_regional_covid_statistics_table.csv -O ./csv/ts_regional_covid_statistics_table.csv
wget $GITHUBURL/raw/main/rds/csv/ts_regional_risk_index_table.csv -O ./csv/ts_regional_risk_index_table.csv
wget $GITHUBURL/raw/main/rds/csv/ts_wallonia_region_table.csv -O ./csv/ts_wallonia_region_table.csv
wget $GITHUBURL/raw/main/rds/csv/vacc.csv -O ./csv/vacc.csv
