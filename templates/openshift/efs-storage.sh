...
### ./efs-storage.sh --base-path=/home/ec2-user --operation=create --subnets=subnet-5c7d2d610d4db25f,subnet-15bca0698e9b4c41,subnet-3ed7835a97324708
##### destroy NFS storage
### ./efs-storage.sh --base-path=/home/ec2-user --operation=destroy
